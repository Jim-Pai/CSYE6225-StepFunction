...
public class ChargeFee implements RequestHandler<Object, Object> {
    ...
    public Object handleRequest(Object input, Context context) {
        ...
        if(containsStudent(courseId, studentId))
    ...
    public boolean containsStudent(String courseId, String studentId) {
